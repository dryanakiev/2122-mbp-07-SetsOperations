...
Associative Containers - map и set

Всяка от реализациите трябва да е в отделен файл, необходимо е да използвате шаблонен тип за съдържащите се в контейнерите данни. 
Имената на файловете трябва да са имената на контейнера, с който е написано решението.
